...
# manual bump, where every other module in this directory rides nixpkgs and
# updates for free. Cursor themes move roughly yearly, so the trade is cheap —
# but it is a trade, and ./borealis.nix is the zero-maintenance fallback.
#
